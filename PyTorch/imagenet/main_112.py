...
parser.add_argument('--model_name', dest='model_name', default='Resnet34',type=str,
...
def save_checkpoint(state, is_best, args, filename='Resnet34_checkpoint.pth.tar'):
    filename=args.model_name + '_checkpoint.pth.tar'
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, args.model_name + '_best.pth.tar')
